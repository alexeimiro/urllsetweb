...
function Privacypolicy() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <h3 className="text-lg font-semibold mb-4">Information Collection and Use</h3>
        <p className="mb-4">We collect several types of information for various purposes to provide and improve our service to you. This may include, but is not limited to, your name, email address, and financial information related to your investments. We use this information to manage your account, provide customer support, and communicate important platform updates or investment opportunities.</p>
      </div>
      <div className="mb-8">
      ...
      <div className="mb-8">
        ...
        <p className="mb-4">Cookies are files with a small amount of data, which may include an anonymous unique identifier. Cookies are sent to your browser from a website and stored on your device. We use cookies to collect information to improve our services for you. You have the option to either accept or refuse these cookies and know when a cookie is being sent to your device. If you choose to refuse our cookies, you may not be able to use some portions of our service.</p>
      </div>
      <div className="mb-8">
      ...
      <div className="mb-8">
        <h3 className="text-lg font-semibold mb-4">Links to Other Sites</h3>
      ...
      <div className="mb-8">
        <h3 className="text-lg font-semibold mb-4">Changes to This Privacy Policy</h3>
